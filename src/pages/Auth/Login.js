...
const clientId = '729691970121-hb3de4cii16sajnq08ng3c1jhb81n844.apps.googleusercontent.com'
/**
 * Login component
 * @param {*} props 
 */
const Login = (props) => {
    ...
    const onSuccess = (res) => {
        ...
        localStorage.setItem("authUser", res.credential);
